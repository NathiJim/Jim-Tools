...
(function() {
  ...
  function update() {
    pending = false;
    var marks = document.getElementById("jt_nav").getElementsByTagName("a"), found;
    ...
    if (found != null && found != prevVal) {
      prevVal = found;
      var lis = document.getElementById("jt_nav").getElementsByTagName("li");
  ...
  window.addEventListener("hashchange", function() {
    setTimeout(function() {
      ...
      var marks = document.getElementById("jt_nav").getElementsByTagName("a");
      for (var i = 0; i < marks.length; i++)
